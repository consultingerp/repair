...
class product(models.Model):
    ...
    horas = fields.Float('Cant. de horas')
    # datetime_field = fields.Datetime(string='Horasss')
...
class fleet_repair(models.Model):
    ...
    def set_to_close(self):
        ...
        self.state = 'closed'
        template = self.env.ref('fleet_repair_management.email_template_car_ticket1_fleet')
        template.send_mail(self.id)  # force_send = True


    @api.one
    def set_to_reopen(self):
        self.state = 'workorder'
    ...
    def action_create_fleet_diagnosis(self):
        ...
        diagnose_vals = {
            ...
            'fleet_repair_line': repair_obj.fleet_repair_line.id,
        }
        ...
        # for line in repair_obj.fleet_repair_line:
        # line = repair_obj.fleet_repair_line
        # fleet_line_vals = {
        #         'fleet_id': line.fleet_id.id,
        #         'license_plate': line.license_plate,
        #         'vin_sn': line.vin_sn,
