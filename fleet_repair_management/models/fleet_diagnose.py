...
class fleet_diagnose(models.Model):
    ...
    spare_part_ids_x = fields.One2many('spare.part.line', 'diagnose_id', string='Spare Parts Needed') #ggg
    spare_part_ids_y = fields.One2many('spare.part.line', 'diagnose_id_y', string='Services Needed')  #ggg
